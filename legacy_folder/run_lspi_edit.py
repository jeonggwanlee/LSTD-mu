...
def _main(episode_num_list, game_title='CartPole', basis_opt="gaussian_sum", basis_function_dim=5, saved_basis_use=True, center_opt="random"):
    """ episode_num_list : each element means # of episode for sampling
        game_title : what the environment is i.e., the title of environment
        basis_opt : basis function style (gaussian, deep action network, etc)
        basis_function_dim : basis function dimension
        save_basis_use :
        center_
    """
    ...
    episode_num_list_str = list(map(str, episode_num_list))
    episodes_str = ','.join(episode_num_list_str)
...
if __name__ == '__main__':
    ...
    episode_num_list = [100]
    #_main(episode_num_list, game_title="CartPole", basis_opt="gaussian_sum", basis_function_dim=20, saved_basis_use=True, center_opt="random")
    #_main(episode_num_list, game_title="CartPole", basis_opt="deep_cartpole", basis_function_dim=30, saved_basis_use=False, center_opt="random")
    #_main(episode_num_list, game_title="CartPole", basis_opt="dan_h1", basis_function_dim=30, saved_basis_use=False, center_opt="random")
    _main(episode_num_list, game_title="CartPole", basis_opt="dan_pred", basis_function_dim=10, saved_basis_use=False, center_opt="random")

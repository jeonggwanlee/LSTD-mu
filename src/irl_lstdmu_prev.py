...
class IRL_LSTDMU:
    ...
    def loop(self, loop_iter):
        ...
        while t > self.epsilon:
            ...
            self.agent_train_wrapper(self.memory,
                                     self.theta,
                                     isRender=False)
            ...
            # Candiate 3 
            jth_optimal_policy = agent.policy
            ...
            if time_checker_option:
                new_trajectories = self._generate_new_trajectories(agent, n_trajectories=1000)
...
if __name__ == '__main__':
    ...
    reward_basis = RewardBasis(state_dim, rb_dim, gamma, feature_means, opt=rb_bfopt)
